        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="<?= base_url('index.php/admin/pesanan')?>" class="active"><i class="lnr lnr-cog"></i> <span>Peminjam</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="keterangan" class="form-control" required="">
                                            ...
                                            <option name="keterangan" value="meminjam">Meminjam</option>
        ...
        ?>
         <div class="modal fade" id="modal_edit<?php echo $id_order;?>" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                       <h3 class="modal-title" id="myModalLabel">Edit Peminjam</h3>
                   </div>
                   <div class="modal-body form">
                    <form action="<?php echo base_url('index.php/admin/editPesanan')?>" enctype="multipart/form-data" class="form-horizontal" method="post">
                        <div class="form-body">
                            ...
                            <div class="form-group" hidden>
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="id_order" placeholder="Nama Peminjam" required="" value="<?= $id_order;?>">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <option value="">--Select Keterangan--</option>
                                        <?php if($ket=='meminjam'):?>
                                            <option name="keterangan" value="meminjam" selected="">Meminjam</option>
                                            <option name="keterangan" value="selesai">Selesai</option>
                                            <?php else:?>
                                                <option name="keterangan" value="meminjam">Meminjam</option>
