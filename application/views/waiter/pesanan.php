    ...
    <div id="sidebar-nav" class="sidebar">
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    <li><a href="<?= base_url('index.php/waiter')?>" class="'"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
                    <li><a href="<?= base_url('index.php/waiter/pesanan')?>" class="active"><i class="lnr lnr-cog"></i> <span>Pesanan</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
...
<script type="text/javascript">
  function get(id) {
    $.ajax({
        url:"<?php echo base_url('index.php/waiter/alldata');?>",
        type:"POST",
        data:{
            kode:id
        },
...
function cek_data()
{
    ...
    $.ajax({
      ...
      url  : "<?php echo base_url('index.php/waiter/view_data');?>",
      cache: false,
      beforeSend: function() {
